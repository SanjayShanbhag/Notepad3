	...
	<head>
        ...
        <script type="text/javascript">
            ...
            function submit(){
                ...
                var url = "addpublicnoteprocess.php";
                if(navigator.onLine){
                    syncing();
                    $.post(url,{title: titl, content: cont}, function(data){
                        ...
                        x.className = "show";
                        setTimeout(function(){ x.className = x.className.replace("show", ""); }, 3000);
                        window.location.href = "pnotes.php?id="+data;
                    });
                }else{
                    var x = document.getElementById("snackbar");
                    x.innerHTML = "OOPS, This Feature requires an internet connection! Please reconnect and try again.";
                    x.className = "show";
                    setTimeout(function(){ x.className = x.className.replace("show", ""); }, 3000);
                }
            }
